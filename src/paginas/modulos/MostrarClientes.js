...
const MostrarClientes =()=>{
   ...
   if(response.msg === 'El cliente ha sido eliminado' ){
    ...
    const msg = 'El cliente no pudo e eliinado correctamente'
    swal ({
        title:'Error',
        text:msg,
        icon:'error',
                                ...
                                <table className="table table-bordered" >
                                    <thead>
                                        <tr>
                                            ...
                                            <th style={{width:'10%'}}>nomeroContacto</th>
                                        ...
                                        {clientes.map((cliente,index)=>(
                                           <tr key={index}>
                                                ...
                                                <td>
                                                    ...
                                                    <button onClick={(e)=>eliminarClientes(e,cliente._id)}className=" btn btn-danger mt-2 mb-2" ><i className="fa-solid fa-trash"></i> </button>
                                                </td> 
                                           </tr>     
                                        ))}
                                    </tbody>
